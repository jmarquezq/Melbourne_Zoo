...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// textBox4
			// 
			this->textBox4->Location = System::Drawing::Point(306, 358);
			...
			// textBox2
			// 
			this->textBox2->Location = System::Drawing::Point(306, 287);
			this->textBox2->Multiline = true;
			this->textBox2->Name = L"textBox2";
			this->textBox2->Size = System::Drawing::Size(213, 39);
			...
			this->label4->Location = System::Drawing::Point(114, 358);
			this->label4->Name = L"label4";
			this->label4->Size = System::Drawing::Size(109, 31);
			this->label4->TabIndex = 63;
			this->label4->Text = L"Descuento:";
			// 
			// label3
			// 
			...
			this->label3->Location = System::Drawing::Point(114, 287);
			this->label3->Name = L"label3";
			this->label3->Size = System::Drawing::Size(64, 31);
			this->label3->TabIndex = 62;
			this->label3->Text = L"Bono:";
			this->label3->Click += gcnew System::EventHandler(this, &registrarCalcularForm::label3_Click);
			// 
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(306, 106);
			...
			this->label8->Location = System::Drawing::Point(114, 116);
			...
			// textBox10
			// 
			this->textBox10->Location = System::Drawing::Point(306, 235);
			...
			this->label13->Location = System::Drawing::Point(115, 229);
			...
			this->toolStrip1->Size = System::Drawing::Size(664, 27);
			...
			// textBox12
			// 
			this->textBox12->Location = System::Drawing::Point(306, 169);
			...
			this->label1->Location = System::Drawing::Point(115, 169);
			...
			// textBox5
			// 
			this->textBox5->Location = System::Drawing::Point(306, 430);
			...
			this->label2->Location = System::Drawing::Point(115, 430);
			...
			// txtCedula
			// 
			this->txtCedula->Location = System::Drawing::Point(306, 55);
			...
			this->label5->Location = System::Drawing::Point(114, 55);
			...
			this->ClientSize = System::Drawing::Size(664, 508);
